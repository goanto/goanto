...
**Freelance Software Architect & AI Infrastructure Specialist | PhD in Distributed Systems | Ex-CTO**
...
### **AI/LLM Stack**
```
🤖  LLM Providers: OpenAI (GPT-4, GPT-5), Anthropic (Claude), Grok
🤖  AI Services: AWS Bedrock, VAPI (Voice AI), Amazon Transcribe
🤖  Frameworks: LangChain, AI agent orchestration, prompt engineering
🤖  Optimization: Multi-provider routing, latency guardrails, cost management
```
...
```
💻  Primary: Python (FastAPI, Flask, Django), Go (microservices, CLI tools)
💻  Backend: Node.js (Express, NestJS), TypeScript
💻  Systems: C++ (performance-critical components), Bash scripting
...
🔌  API Styles: REST, gRPC, GraphQL, WebSockets
🔌  Architecture: Microservices, Event-driven, Serverless
🔌  Authentication: JWT, OAuth2, API keys, HashiCorp Vault
```

### **Databases & Data Stores**
```
💾  Relational: PostgreSQL (optimization, replication, partitioning)
...
```
📊  Logging: ELK Stack (Elasticsearch, Logstash, Kibana), AWS CloudWatch
📊  Metrics: Prometheus, Grafana, CloudWatch Metrics
📊  Tracing: Distributed tracing, APM tools
📊  Alerting: PagerDuty, CloudWatch Alarms, Slack integrations
```

### **Mobile Development**
```
📱  Cross-platform: React Native, Flutter
📱  Native iOS: Swift, Xcode, App Store deployment
📱  Native Android: Kotlin, Android Studio, Play Store deployment
📱  Backend Integration: REST APIs, real-time data sync, push notifications
```
